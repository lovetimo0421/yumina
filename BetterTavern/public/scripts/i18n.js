...
export async function initLocales() {
    ...
    // Onboarding language select only stores the preference — no reload.
    // The language switch takes effect after the user finishes onboarding.
    $('#onboarding_ui_language_select').on('change', function () {
        const language = String($(this).val());
