...
export function initRossMods() {
    ...
    // This handler originally saved the clicked character as the "auto-load" character,
    // so the app would remember and reopen that character on next visit.
    // BetterTavern replaces this with the Recent Worlds system:
    //   - Recent worlds are tracked server-side via /api/chats/recent
    //   - The sidebar shows recent worlds for the user to choose from
    //   - welcome-screen.js handles opening recent worlds and calls setActiveCharacter()
    // The interceptor in bettertavern-character-profile.js blocks this handler.
    // Additionally, auto_load_chat is disabled by default (power_user.js line 339).
    // To restore: uncomment this and ensure auto_load_chat is enabled.
    //
