...
async function onNarrateText(args, text) {
    ...
    const name = (baseName === 'Yumina System' ? DEFAULT_VOICE_MARKER : baseName) || DEFAULT_VOICE_MARKER;
...
function getCharacters(unrestricted) {
    ...
    if (extension_settings.tts.multi_voice_enabled) {
        ...
        for (const char of characters) {
            if (char === DEFAULT_VOICE_MARKER || char === 'Yumina System') {
